...
public class PlatoonSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PlatoonPackage.TURN_LEFT: {
				...
				if (result == null) result = caserouteCommand(turnLeft);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.TURN_RIGHT: {
				...
				if (result == null) result = caserouteCommand(turnRight);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.FORWARD: {
				...
				if (result == null) result = caserouteCommand(forward);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.ROUTE_COMMAND: {
				routeCommand routeCommand = (routeCommand)theEObject;
				T result = caserouteCommand(routeCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PlatoonPackage.FOLLOWING_VEHICLE: {
				FollowingVehicle followingVehicle = (FollowingVehicle)theEObject;
				T result = caseFollowingVehicle(followingVehicle);
				if (result == null) result = caseVehicle(followingVehicle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PlatoonPackage.LEADER_VEHICLE: {
				LeaderVehicle leaderVehicle = (LeaderVehicle)theEObject;
				T result = caseLeaderVehicle(leaderVehicle);
				if (result == null) result = caseVehicle(leaderVehicle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>route Command</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>route Command</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caserouteCommand(routeCommand object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFollowingVehicle(FollowingVehicle object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Leader Vehicle</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Leader Vehicle</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLeaderVehicle(LeaderVehicle object) {
		return null;
	}

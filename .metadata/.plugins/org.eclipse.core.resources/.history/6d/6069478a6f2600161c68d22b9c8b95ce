...
public class PlatoonAdapterFactory extends AdapterFactoryImpl {
	...
	protected PlatoonSwitch<Adapter> modelSwitch =
		new PlatoonSwitch<Adapter>() {
			...
			@Override
			public Adapter caserouteCommand(routeCommand object) {
				return createrouteCommandAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseFollowingVehicle(FollowingVehicle object) {
				return createFollowingVehicleAdapter();
			}
			@Override
			public Adapter caseLeaderVehicle(LeaderVehicle object) {
				return createLeaderVehicleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.routeCommand <em>route Command</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createrouteCommandAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.FollowingVehicle <em>Following Vehicle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.LeaderVehicle <em>Leader Vehicle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link platoon.Root <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

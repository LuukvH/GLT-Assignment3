...
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.ROOT__PLATOON);
			childrenFeatures.add(PlatoonPackage.Literals.ROOT__ROUTE);
			childrenFeatures.add(PlatoonPackage.Literals.ROOT__CONSTRAINTS);
		}

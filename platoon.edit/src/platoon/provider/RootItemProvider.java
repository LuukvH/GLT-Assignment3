...
/**
 * This is the item provider adapter for a {@link platoon.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_platoon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_platoon_feature", "_UI_Root_type"),
				 PlatoonPackage.Literals.ROOT__PLATOON,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRoutePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_route_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_route_feature", "_UI_Root_type"),
				 PlatoonPackage.Literals.ROOT__ROUTE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addConstraintsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Root_constraints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Root_constraints_feature", "_UI_Root_type"),
				 PlatoonPackage.Literals.ROOT__CONSTRAINTS,
				 true,
				 false,
				 true,
				 null,
